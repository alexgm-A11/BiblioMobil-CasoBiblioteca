...
private val ACCESOS=listOf(Acceso("Registrar libros","Administra el catálogo",Screen.Libros,Icons.Default.MenuBook),Acceso("Registrar lectores","Gestiona la cartera",Screen.Lectores,Icons.Default.People),Acceso("Revisar préstamos","Módulo próximo",Screen.Prestamos,Icons.Default.Bookmark))
